...
#define NSPEEDS         9
#define DATAFILENAME "./png/iter.dat"
#define AVVELSFILE      "av_vels.dat"
#define NUMOFTHREADS 90
...
int write_values(const t_param params, t_speed* cells, int* obstacles, float* av_vels, int tt);
...
int main(int argc, char* argv[])
{
  ...
  for (int tt = 0; tt < params.maxIters; tt++){
    ...
    if (tt % params.framerate == (params.framerate - 1)){
      ...
      std::string command = "mv ./png/iter.dat ./png/iter" + std::to_string(1000+(tt+1)/25) + ".dat";
  ...
  //system("cd png && convert -delay 4 -loop 1 *.png animation.gif");
  //system("cd png && rm ./*.png iter.dat");
